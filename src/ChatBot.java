public class ChatBot {
    ...
    // method that tells a joke
    public void tellJoke()
    {
        System.out.println("Hey! Want to hear a joke?");
        System.out.println("What do you call two banana peels on the floor?");
        System.out.println("A pair of slippers!");
    }

    // method that returns how old the user is
    public int userAge(int userBirthday)
    {
